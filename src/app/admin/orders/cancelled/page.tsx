...
import { Eye, ArchiveX, Printer } from 'lucide-react';
...
export default function AdminCancelledOrdersPage() {
  ...
  useEffect(() => {
    async function fetchOrders() {
      try {
        ...
        // Filtra para mostrar apenas pedidos cancelados
  ...
  return (
    <div>
      <h1 className="text-3xl font-bold font-headline mb-8">Pedidos Cancelados</h1>
                ...
                <TableRow>
                    <TableCell colSpan={6} className="text-center h-24">
                       <div className="flex flex-col items-center gap-2">
                           ...
                           <span className="text-muted-foreground">Nenhum pedido cancelado encontrado.</span>
                        </div>
                    </TableCell>
                </TableRow>
            )}
